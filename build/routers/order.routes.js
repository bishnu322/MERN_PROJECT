...
router.post("/", (0, auth_middleware_1.authenticate)(global_types_1.users), order_controller_1.createOrder);
router.get("/all", (0, auth_middleware_1.authenticate)(global_types_1.allAdmin), order_controller_1.getAll);
router.get("/", (0, auth_middleware_1.authenticate)(global_types_1.users), order_controller_1.getAllByUser);
